...
import os,sys, json
PROJECT_ROOT = '/Users/rimi/project/yunwei'
...
from yunwei.settings import BASE_DIR
...
class MyInventory():
    ...
    def __init__(self,resource,loader=None,variable_manager=None):
    ...
    def add_dynamic_group(self, hosts, groupname, groupvars=None):
        ...
        for host in hosts:
            ...
            self.variable_manager.set_host_variable(host=my_host, varname='ansible_become_pass', value=password)
...
class ANSRunner(object):
    ...
    def __initializeData(self):
        ...
        Options = namedtuple('Options', ['connection','module_path', 'forks', 'timeout',  'remote_user',
                ...
                'check', 'listhosts', 'listtasks', 'listtags', 'syntax','diff','passwords'])
        ...
        self.options = Options(connection='smart',module_path=None, forks=100, timeout=10,
                ...
                listtasks=False, listtags=False, syntax=False, diff=True, passwords=None)

        self.passwords = dict(ssh_pass=None, become_pass=None)
...
#     #              ]
    resource =  {
                    "test": {
                        "hosts": [
                                    # {'username': 'rimi', 'password': '123', 'ip': '10.2.0.159','hostname':'10.2.0.159','port':'22'},
                                    # {"hostname":"10.2.0.122","ip": "10.2.0.122", "port": "22", "username": "admin", "password":"123"},
                                    # {"hostname": "10.2.0.125", "ip": "10.2.0.125", "port": "22", "username": "denghui","password": "123"},
                                    {"hostname": "10.2.0.159", "ip": "10.2.0.159", "port": "22", "username": "admin",
                             "password": "123"},
                                  ],
                        "vars": {
                                 "var1":"ansible",
...
#     # Ansible Adhoc
    rbt.run_model(host_list=['10.2.0.159',],module_name='ping',module_args="")
    data = rbt.get_model_result()
    print(data)
#     Ansible playbook
#     rbt.run_playbook(playbook_path='install_nginx')
#     x=1
#     data = rbt.get_playbook_result()
#     print(data)
    # rbt.run_model(host_list=['10.2.0.33',],module_name='yum',module_args="name=htop state=present")
